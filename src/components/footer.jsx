...
import olxphoneview from '../images/phone-app.png'
...
function Footer() {
  return (
    ...
    <div>
      <div className="container">
        ...
        <div class="row">
          <div class="col-4">
            ...
            <img src={olxphoneview} alt="" />

          </div>
          <div class="col-5">
            <span>

              <h2 className="olxfooterfont1">TRY THE OLX APP</h2>
              <h4 className="olxfooterfont2">Buy, sell and find just about anything using the app on your mobile.</h4>
            </span>
          </div>
          <div class="col-3">
            <span className="olxfooterfont3">GET YOUR APP TODAY</span>
            <br />
            <br />
            <span><img className="appstore" src={appstore} alt="" /></span>
            <span><img className="appstore" src={playstore} alt="" /></span>
      ...
      <div className="endfooterbase">

        <div className="container">
          <span>Other Countries Pakistan-Turkey</span>
          <span className="freeclassified">Free Classifieds in Pakistan. © 2006-2020 OLX</span>
